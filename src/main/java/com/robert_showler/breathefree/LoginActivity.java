...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecoverPassTV = findViewById(R.id.textRecoverPassword);
        mLoginBtn = findViewById(R.id.buttonLogIn);
        mSignup = findViewById(R.id.textSignUp);
        mGoogleLoginBtn = findViewById(R.id.buttonSignInGoogle);
...
/*TESTING
 ...
 2.On app start Check if user signed in stay in HomepageActivity otherwise go to MainActivity ;
 3.Login User with Email and Password;
 4.After LoggingIn go to MainActivity;
 */